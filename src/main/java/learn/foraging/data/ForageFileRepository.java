...
//        System.out.println(forage.getId());
//        System.out.println(forage.getForager().getId());
//        System.out.println(forage.getItem().getId());
        if(!isValidForage(forage)) {
//            System.out.println("error?");
    ...
    private boolean isValidForage(Forage forage) {
        ...
        if(forage.getDate()==null || forage.getDate().isAfter(LocalDate.now())){
            return false;
        }
        ...
        List<Forage> allForagesSameDay=findByDate(forage.getDate());

        if(allForagesSameDay.stream().anyMatch(f->f.getItem().getId()==forage.getItem().getId() &&
